// Render Gem Pack Vol 5 news slides to PNG at 1080x1440.
//   node "FEED POST/NEWS/Gem Pack Vol 5/render.mjs"
...
(async () => {
  ...
  try {
    const slides = [
      ["slide_01_hook.html", "slide_01.png"],
      ["slide_02_detail.html", "slide_02.png"],
      ["slide_03_numbers.html", "slide_03.png"],
      ["slide_04_grid.html", "slide_04.png"],
      ["slide_05_cta.html", "slide_05.png"],
    ];
    for (const [html, png] of slides) {
      await renderSlide(browser, base, html, png);
    }
  } finally {
    await browser.close();
    server.close();
