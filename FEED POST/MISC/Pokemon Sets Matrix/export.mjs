// Export the Pokemon Sets Matrix carousel for Instagram.
//
//   node "Goka Trades Feed Posts/Pokemon Sets Matrix/export.mjs"
//
// Outputs:
//   slide_01.png, slide_02.png  — 1080x1440 PNG
...
(async () => {
  ...
  try {
    await renderSlide(browser, base, "slide_01_matrix.html", "slide_01.png");
